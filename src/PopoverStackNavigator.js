...
try {
  const createNavigationContainer = require('../../react-navigation/src/createNavigationContainer');
  const createNavigator = require('../../react-navigation/src/navigators/createNavigator');
  const CardStackTransitioner = require('.../../react-navigation/src/views/CardStack/CardStackTransitioner');
  const StackRouter = require('../../react-navigation/src/routers/StackRouter');
  const NavigationActions = require('../../react-navigation/src/NavigationActions');
  ...
  const PopoverStackNavigator = () => {
    class PopoverNoReactNavigation extends Component {
      render() {
        return null;
      }
    }

    return PopoverNoReactNavigation;
  };
}
